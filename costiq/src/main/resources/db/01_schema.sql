...
CREATE TABLE packaging_items (
    ...
    base_cost_usd   DECIMAL(12,4) NOT NULL,
    min_order_qty   INT UNSIGNED  NOT NULL DEFAULT 1000,
    is_active       TINYINT(1)   NOT NULL DEFAULT 1,
    created_at      DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
...
-- =============================================================
-- PROMOTIONAL CAMPAIGNS (Happy Meal style toy giveaways)
-- =============================================================
...
CREATE TABLE toy_items (
    ...
    sku             VARCHAR(30)  NOT NULL UNIQUE,
    name            VARCHAR(200) NOT NULL,
    toy_category_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE campaign_toy_allocations (
    ...
    toy_item_id     BIGINT UNSIGNED NOT NULL,
    country_id      BIGINT UNSIGNED NOT NULL,
    supplier_id     BIGINT UNSIGNED NOT NULL,
    fiscal_period_id BIGINT UNSIGNED NOT NULL,
    quantity        BIGINT UNSIGNED NOT NULL,
